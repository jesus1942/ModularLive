const STRUCTURE_SYSTEMS = {
  steel_tube: {
    ...
    roofInsulation: "Lana mineral 150 mm",
    roofMembrane: "Membrana hidrófuga e impermeable",
    windBarrier: "Membrana hidrófuga y barrera de viento",
    fastener: "Tornillos autoperforantes para acero",
  ...
  light_steel: {
    ...
    floorJoist: "Perfil C 200x70x2 mm",
    perimeterBeam: "Perfil C 200x70x2 mm",
    wallStud: "Perfil C 100x50x0.9 mm",
    roofRafter: "Perfil C 150x50x1.25 mm",
    openingFrame: "Perfil C/U 100x50x0.9 mm",
    structuralPanel: "Placa OSB estructural 11 mm",
    floorInsulation: "Lana de vidrio 100 mm",
    wallInsulation: "Lana de vidrio 100 mm",
    roofInsulation: "Lana de vidrio 150 mm",
    roofMembrane: "Membrana impermeable bajo cubierta",
    windBarrier: "Housewrap hidrófugo",
    fastener: "Tornillos punta aguja y mecha",
    anchor: "Bulones de anclaje para perfil galvanizado",
    sealant: "Cinta y sellador para encuentros",
    notes:
  ...
  wood: {
    ...
    floorJoist: "Tirante 2x8 pulgadas",
    perimeterBeam: "Tirante laminado 3x8 pulgadas",
    wallStud: "Tirante 2x4 pulgadas",
    roofRafter: "Tirante 2x6 pulgadas",
    openingFrame: "Tirante 2x4 pulgadas",
    structuralPanel: "Placa OSB estructural 11 mm",
    floorInsulation: "Lana de vidrio 100 mm",
    wallInsulation: "Lana de vidrio 100 mm",
    roofInsulation: "Lana de vidrio 150 mm",
    roofMembrane: "Membrana impermeable bajo chapa",
    windBarrier: "Membrana hidrófuga transpirable",
    fastener: "Clavos y tornillos para madera",
    anchor: "Anclajes metálicos y escuadras",
    sealant: "Espuma expansiva y sellador elástico",
    notes:
...
const CLADDING_SYSTEMS = {
  ...
  cement_board: {
    label: "Placa cementicia",
    unit: "u",
    coverageArea: 2.88,
    detail: "Placa comercial 1,20 x 2,40 m"
  },
  sandwich_panel: {
    label: "Panel sándwich",
    unit: "u",
    coverageArea: 2.4,
